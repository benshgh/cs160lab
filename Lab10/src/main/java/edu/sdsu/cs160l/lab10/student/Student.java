...
import edu.sdsu.cs160l.lab10.college.IRegistrar;
import edu.sdsu.cs160l.lab10.college.IRegistrarChangeListener;
...
public class Student implements IStudentStatus,
  ...
  public String toString() {
    ...
    return "ID = " + redId + ", Level = " + studentLevel + ", Major/s = " + sb;
  }
